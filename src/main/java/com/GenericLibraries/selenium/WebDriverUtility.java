 ...
 */
	public WebDriver launchAndMaximizeBrowser(String browser) {
		...
		break;
		default:
			System.out.println("invaloid browser info");		
	...
	/**
	 * This method will navigate to application
	 * @param url
	 */
	 ...
	 * @param time
	 */
	public void waitTillElementsFound(long time) {
	...
	/**
	 * this method waits until the element is enabled to click
	 * @param element
	 * @param time
	 * @return
	 */
	...
	/**
	 * This method waits until tiltle of the web page is displayed
	 * @param time
	 * @param tiltle
	 * @return
	 */
...
/**
 * This method is used to mouse hover opn an element
 * @param element
 */
...
/**
 * This method is used to select ana an element from top drop down based on value
 * @param element
 * @param index
 */
